...
public class FTPUtil {
    private static final String FTP_IP=PropertiesUtils.readKey("ftp.server.ip");
    private static final String FTP_USERNAME=PropertiesUtils.readKey("ftp.server.user");
    private static final String FTP_PASSWORD=PropertiesUtils.readKey("ftp.server.password");
